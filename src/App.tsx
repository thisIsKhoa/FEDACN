...
const AppShell: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--bg-base)] px-6">
        <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] px-6 py-5 text-sm text-[var(--text-secondary)]">
  ...
  const backendPillClass =
    backendStatus === "ok"
      ? "bg-[var(--state-success-bg)] text-[var(--state-success)] border-[var(--state-success-border)]"
      : backendStatus === "error"
        ? "bg-[var(--state-danger-bg)] text-[var(--state-danger)] border-[var(--state-danger-border)]"
        : "bg-[var(--state-neutral-bg)] text-[var(--text-secondary)] border-[var(--border-subtle)]";
  const backendLabel =
    backendStatus === "ok"
      ? "BE Online"
      : backendStatus === "error"
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      >
        {/* Logo */}
        <div
          className={`flex items-center gap-3 px-5 h-16 border-b border-[var(--border-subtle)] shrink-0 ${collapsed ? "justify-center px-3" : ""}`}
        >
        ...
        {/* User section */}
        <div
          className={`px-4 py-3 border-t border-[var(--border-subtle)] shrink-0 ${collapsed ? "px-2" : ""}`}
        >
          {!collapsed ? (
            <div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 flex items-center justify-between px-6 border-b border-[var(--border-subtle)] bg-[var(--bg-surface)] shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => void logout()}
              className="btn btn-ghost btn-sm flex items-center gap-2 text-[var(--state-danger)] hover:bg-[var(--state-danger-bg)] hover:text-[var(--state-danger)]"
        ...
        <main
          id="main-content"
          className="flex-1 overflow-y-auto px-6 py-6 bg-[var(--bg-base)] mobile-main-content"
        >
          <ErrorBoundary>
            <Routes>
              {/* Customer */}
              ...
              <Route
                ...
                element={<CancellationPoliciesPage />}
              />
